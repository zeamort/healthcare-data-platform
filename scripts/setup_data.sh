...
echo "    3. ml-redshift         (clustering + risk scoring via Redshift ML)"
echo "    4. ml-comorbidity      (disease co-occurrence mining)"
echo ""
echo "  Monitor progress (live-tail every pipeline Lambda in one stream):"
echo "    ./scripts/tail_all.sh batch"
echo ""
echo "  To start the streaming simulator after batch completes:"
echo "    ./scripts/stream_demo.sh       # or: python3 etl/stream_simulator.py"
echo ""
